...
const putButton = document.getElementById('put-js')
...
console.log(time)
    ...
    getButton.addEventListener('click', event => {
      axios.get(`http://127.0.0.1:3000/api/v1/user/stumblings/${searching.id}`).then(res => resHtml.insertAdjacentText('afterbegin', JSON.stringify(res.data)))
    });
